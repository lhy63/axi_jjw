...
public:
    ...
    uint32_t timeCheck;
    bool waveEnabled;
    VTopAxiMasterWandRWithSlave top;
    ...
    Wrapper_1(const char * name){
      ...
      waveEnabled = true;
      signalAccess[0] = new SDataSignalAccess( top.TopAxiMasterWandRWithSlave->axiSlave->regAwAddr );
      signalAccess[1] = new CDataSignalAccess( top.io_rdataOut_valid );
      signalAccess[2] = new CDataSignalAccess( top.io_rdataOut_ready );
      signalAccess[3] = new CDataSignalAccess( top.io_rdataOut_payload );
      signalAccess[4] = new CDataSignalAccess( top.io_rapStart );
      signalAccess[5] = new IDataSignalAccess( top.io_RAddrOffset );
      signalAccess[6] = new IDataSignalAccess( top.io_Rlen );
      signalAccess[7] = new CDataSignalAccess( top.io_rapDone );
      signalAccess[8] = new CDataSignalAccess( top.io_wapStart );
      signalAccess[9] = new CDataSignalAccess( top.io_wdata_in_valid );
      signalAccess[10] = new CDataSignalAccess( top.io_wdata_in_ready );
      signalAccess[11] = new CDataSignalAccess( top.io_wdata_in_payload );
      signalAccess[12] = new IDataSignalAccess( top.io_WAddrOffset );
      signalAccess[13] = new IDataSignalAccess( top.io_Wlen );
      signalAccess[14] = new CDataSignalAccess( top.io_wapDone );
      ...
      top.trace(&tfp, 99);
      tfp.open((std::string("/home/lhy/IdeaProjects/AXI_JJW/./simWorkspace/TopAxiMasterWandRWithSlave/") + name + ".fst").c_str());
      #endif
      this->name = name;
    }
    ...
    virtual ~Wrapper_1(){
      ...
      #endif
      #ifdef COVERAGE
      VerilatedCov::write((("/home/lhy/IdeaProjects/AXI_JJW/./simWorkspace/TopAxiMasterWandRWithSlave/") + name + ".dat").c_str());
      #endif
    }
